...
function Category() {
    const data = [
        {
            ...
            "picture": 
                <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                    ...
                    <g clip-path="url(#clip0_2903_104)">
                        <path
                        ...
                        <path d="M28 44.0052V44.0305" stroke="black" stroke-width="2.5"
                            stroke-linecap="round" stroke-linejoin="round" />
                        <line x1="15.1667" y1="39.8333" x2="40.8333" y2="39.8333" stroke="black"
                            stroke-width="2" />
                    </g>
                    <defs>
                        <clipPath id="clip0_2903_104">
        ...
        },
        {
            ...
            <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_2903_535)">
                    <path
        ...
        },
        {
            ...
            <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_2903_227)">
                    <path
        ...
        },
        {
            ...
            <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_2903_248)">
                    <path
        ...
        },
        {
            ...
            <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_2903_257)">
                    <path
        ...
        },
        {
            ...
            <svg width="56" height="56" viewBox="0 0 56 56" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <g clip-path="url(#clip0_2903_907)">
                    <path
    ...
    let cards = data?.map((el)=>
        <div key={el.id} className="categories-section__categories--card">
            <div>{el.picture}</div>
            <p>{el.title}</p>
        </div>
    )
